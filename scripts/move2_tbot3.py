...
class moveTbot3:
	def __init__(self):
		...
		self.action_subscriber = rospy.Subscriber('robot2/actions',String,self.callback_actions)
		self.pid_subscriber = rospy.Subscriber("robot2/Controller_Status",String,self.callback_pid)
		self.pose_subscriber = rospy.Subscriber('robot2/odom',Odometry,self.pose_callback)
		self.status_publisher = rospy.Publisher("robot2/status",String,queue_size = 10)
