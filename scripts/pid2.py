...
class PID(object):
	...
	def __init__(self, target_pose, mode):
		...
		rospy.Subscriber('robot2/odom', Odometry, self.pose_callback, queue_size=1)
		self.velocity_publisher = rospy.Publisher('robot2/cmd_vel', Twist, queue_size=1)
		self.controller_status_publisher = rospy.Publisher('robot2/Controller_Status', String, queue_size=1)
